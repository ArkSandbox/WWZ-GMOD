...
-- Misc --
ENT.PrintName = "Infectado Hombre"
...
-- Sounds --
ENT.OnIdleSounds = {
  "zn/z1.wav", "zn/z2.wav", "zn/z3.wav", "zn/z4.wav",
  "zn/z5.wav", "zn/z6.wav", "zn/z7.wav", "zn/z8.wav"
}
ENT.OnDamageSounds = {
  "zn/z1.wav", "zn/z2.wav", "zn/z3.wav", "zn/z4.wav",
  "zn/z5.wav", "zn/z6.wav", "zn/z7.wav", "zn/z8.wav"
  ...
  [IN_DUCK] = {
    {
      coroutine = true,
      onkeydown = function(self)
        -- Insert code for duck key press
      end
    }
  },
  [IN_RELOAD] = {
    {
      coroutine = true,
      onkeydown = function(self)
        -- Insert code for reload key press
      end
    }
  },
  [IN_JUMP] = {
    {
      coroutine = true,
      onkeydown = function(self)
        -- Insert code for jump key press
      end
    }
  }
}
...
if SERVER then
  ...
  function ENT:CustomInitialize()
    self:SequenceEvent("walk_all", 2 / 5, function()
      self:EmitStep()
    end)
    self:SequenceEvent("walk_all", 4 / 5, function()
      self:EmitStep()
    end)

    self:SequenceEvent("run_all_02", 2 / 5, function()
      self:EmitStep()
    end)
    self:SequenceEvent("run_all_01", 4 / 5, function()
      self:EmitStep()
    end)

    self:SetDefaultRelationship(D_HT)
    self:SequenceEvent("zombie_attack_special", {1 / 11, 1 / 11, 1 / 11, 1 / 11, 1 / 11, 1}, self.Termaattack1)
    self:SequenceEvent("attackG_quick", {1 / 11, 1 / 11, 1 / 11, 1 / 11, 1 / 11, 1}, self.Termaattack1)
  end
